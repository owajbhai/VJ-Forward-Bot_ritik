...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://sarifbhaiyt56:fEzkJJlancbkVDBu@cluster0.oqeojg9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    DATABASE_NAME = environ.get("DATABASE_NAME", "vj-forward-bot")
    BOT_OWNER = int(environ.get("BOT_OWNER", "Ritikmoves2"))
